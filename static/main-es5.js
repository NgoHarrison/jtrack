...
var JobApiService = /** @class */ (function () {
    function JobApiService(_http) {
        this._http = _http;
    }
    JobApiService_1 = JobApiService;
    JobApiService._handleError = function (err) {
    ...
    var JobApiService_1;
    JobApiService.ctorParameters = function () { return [
